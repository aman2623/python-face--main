...
def contact():
    mess._show(title='Contact us', message="Please contact us on : saintlucifer00210@gmail.com ")
...
message3 = tk.Label(window, text="Attendace by Face Recognition Develop by Aman " ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
